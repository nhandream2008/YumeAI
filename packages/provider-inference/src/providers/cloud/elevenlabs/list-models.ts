export const models = [
  {
    ...
    token_cost_factor: 1,
    description: 'The most expressive ElevenLabs text-to-speech model, with audio tags and support for more than 70 languages.',
  ...
  },
  {
    ...
    serves_pro_voices: true,
    token_cost_factor: 1,
    description: 'An expressive real-time ElevenLabs model for conversational use in more than 70 languages.',
    requires_alpha_access: false,
    max_characters_request_free_user: 5000,
    max_characters_request_subscribed_user: 5000,
    maximum_text_length_per_request: 5000,
