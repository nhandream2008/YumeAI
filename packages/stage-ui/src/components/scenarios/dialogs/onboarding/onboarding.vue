...
const skipFutureOnboarding = shallowRef(false)
  ...
  const coreSteps: OnboardingStep[] = [
    {
      ...
      props: () => ({
        ...
        onSkipPreferenceChange: (value: boolean) => {
          skipFutureOnboarding.value = value
        },
      }),
    },
    {
