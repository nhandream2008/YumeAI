...
<template>
  <div class="space-y-2">
    ...
    <div class="flex flex-col items-center justify-center py-2">
      <div class="relative h-32 w-32 select-none overflow-hidden rounded-full">
        ...
        <div
          ...
          :style="{ transform: `translate(-50%, -50%) scale(${1.18 + (volumeLevel / 100) * 0.32})`, opacity: String(0.08 + (volumeLevel / 100) * 0.15) }"
