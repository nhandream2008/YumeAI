        ...
        <template #before-build-info>
          ...
          >
            ...
            <div :class="['flex flex-col gap-4']">
              ...
              >
                YumeAI is installed in a protected Windows folder. Update install may require a UAC admin prompt.
              ...
              <div v-if="updateState.status === 'available'" :class="['flex flex-col gap-4']">
                ...
                <div
                  ...
                  :class="['text-sm rounded-xl border border-amber-500/30 bg-amber-500/10 p-3 text-amber-700 dark:text-amber-200']"
                >
                  Selected channel offers an older build than your current version. Installing this update will downgrade YumeAI.
                </div>
                <div>
                  <Button
